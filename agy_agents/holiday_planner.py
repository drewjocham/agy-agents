...
holiday_planner_prompt = """You are a Holiday Planner Agent.
Your job is to coordinate travel plans, organize itineraries, and ensure a seamless travel experience for the user.
...
class HolidayPlannerAgent:
    ...
    async def run(
        ...
        return await self.provider.execute_agent(
            prompt=prompt,
            system_instruction=holiday_planner_prompt,
